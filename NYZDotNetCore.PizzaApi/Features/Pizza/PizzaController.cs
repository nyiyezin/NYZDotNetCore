...
using NYZDotNetCore.PizzaApi.Db;
using NYZDotNetCore.Shared;

namespace NYZDotNetCore.PizzaApi.Features.Pizza
{
    ...
    public class PizzaController : ControllerBase
    {
        ...
        {
            var item = _dapperService.QueryFirstOrDefault<PizzaOrderInvoiceHeadModel>(PizzaQuery.PizzaOrderQuery, new { PizzaOrderInvoiceNo = invoiceNo });
            var lst = _dapperService.Query<PizzaOrderInvoiceDetailModel>(PizzaQuery.PizzaOrderDetailQuery, new { PizzaOrderInvoiceNo = invoiceNo });
